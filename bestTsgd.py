...
def bestTimeGau(tipo2, time=-1):
    print ("best gaussian")
    v = np.pi
    if tipo2 == "human":
        #l = [0.0001,0.005,.01,0.05,0.1,0.5,1,1.5,2,3,4,5,6,7,8]
        l = [10*v,15*v, 20*v, 25*v,30*v] 
        n_experiments = 96
        ...
        for i in l:
            ...
            for k in range(n_experiments):
                ...
                try:
                    path = '2sgdGau'+tipo2+'lr0.05-w'+str(i)+'a0.012-'+str(k) #0.009000001-'+str(k)
                    with open('speedres/'+path+'.txt', 'r') as f:
                        array = np.loadtxt(f)
                except Exception:
                    continue
                
                temp.append(array[time])
                # Store results
            temp = np.array(temp)
        ...
        for i in l:
            ...
            for k in range(n_experiments):
                try:
                    ...
                    path = '2sgdGau'+tipo2+'lr0.01-w'+str(i)+'a0.012-'+str(k) #0.009000001-'+str(k)
                    with open('speedres/'+path+'.txt', 'r') as f:
                        array = np.loadtxt(f)
                    temp.append(array[time])
                    # Store results
...
def bestTime(tipo2, time):
    print ("best design")
    if tipo2 == "human":
        #l = [0.0001,0.005,.01,0.05,0.1,0.5,1,1.5,2,3,4,5,6,7,8]
        l = [2**(-i-1) for i in range(6)]+[i for i in range(1,15)]+[37]
        n_experiments = 44
        mean_values = []
        median_values = []
        min_values = []
        for i in l:
            ...
            for k in range(n_experiments):
                #path = 'Fix'+str(i)+'Mean'+tipo2+'lr0.001-w235.61944901923448a0.012-'+str(k) 
                path = 'sgd'+str(i)+'RhoMean'+tipo2+'lr0.05-w235.61944901923448a0.012-'+str(k) #0.009000001-'+str(k)
                with open('speedres/'+path+'.txt', 'r') as f:
                    array = np.loadtxt(f)
    ...
    if tipo2 == "brain":
        #l = [i for i in range(1,33)]
        l = [i for i in range(1,15)]+[2**(-i-1) for i in range(10)]+[32]	
        n_experiments = 43
        mean_values = []
        median_values = []
        min_values = []
        for i in l:
            ...
            for k in range(n_experiments):
                #path = 'Fix'+str(i)+'Mean'+tipo2+'lr0.001-w282.7433388230814a0.012-'+str(k)
                path = 'sgd'+str(i)+'RhoMean'+tipo2+'lr0.05-w282.7433388230814a0.012-'+str(k) #0.009000001-'+str(k)
                with open('speedres/'+path+'.txt', 'r') as f:
                    array = np.loadtxt(f)
                temp.append(array[time])
                # Store results
        ...
        return best_mean_function[0], best_median_function[0], best_min_function[0]
    if tipo2 == "3d":
        l = [i for i in range(1,7)]+[2**(-i-1) for i in range(3)]#+[82]
        n_experiments = 42
        mean_values = []
        median_values = []
        min_values = []
        for i in l:
            ...
            for k in range(n_experiments):
                #path = 'Fix'+str(i)+'Mean'+tipo2+'lr0.01-w70.68583470577035a0.012-'+str(k) 
                path = 'sgd'+str(i)+'RhoMean'+tipo2+'lr0.005-w70.68583470577035a0.012-'+str(k) #0.009000001-'+str(k)
                with open('speedres/'+path+'.txt', 'r') as f:
                    array = np.loadtxt(f)
                temp.append(array[time])
                # Store results
...
def plot(tipo, time):
    tipo2 = "human"
    mean, median, minimum = bestTime(tipo2, time)
    meanGau, medianGau, minimumGau = bestTimeGau(tipo2, time)
    ...
    for i, G in zip(l,lGau):
        for k in range(n_experiments):
            ...
            with open('speedres/'+path+'.txt', 'r') as f:
                array = np.loadtxt(f)
            values.append(array)
            path = 'sgdUni'+tipo2+'lr0.05-w235.61944901923448a0.012-'+str(k) #0.009000001-'+str(k)
            with open('speedres/'+path+'.txt', 'r') as f:
                array = np.loadtxt(f)
            valuesuni.append(array)
            path = 'sgdGau'+tipo2+'lr0.05-w'+str(G)+'a0.012-'+str(k) #0.009000001-'+str(k)
            with open('speedres/'+path+'.txt', 'r') as f:
                array = np.loadtxt(f)
    ...
    for i, G in zip(l,lGau):
        for k in range(n_experiments):
            ...
            with open('speedres/'+path+'.txt', 'r') as f:
                array = np.loadtxt(f)
            values.append(array)
            path = 'sgdUni'+tipo2+'lr0.05-w282.7433388230814a0.012-'+str(k) #0.009000001-'+str(k)
            with open('speedres/'+path+'.txt', 'r') as f:
                array = np.loadtxt(f)
            valuesuni.append(array)
            path = 'sgdGau'+tipo2+'lr0.05-w'+str(G)+'a0.012-'+str(k) #0.009000001-'+str(k)
    ...
    for i, G in zip(l,lGau):
        for k in range(n_experiments):
            ...
            with open('speedres/'+path+'.txt', 'r') as f:
                array = np.loadtxt(f)
            values.append(array)
            path = 'sgdUni'+tipo2+'lr0.005-w70.68583470577035a0.012-'+str(k) #0.009000001-'+str(k)
            with open('speedres/'+path+'.txt', 'r') as f:
                array = np.loadtxt(f)
            valuesuni.append(array)
            path = 'sgdGau'+tipo2+'lr0.005-w'+str(G)+'a0.012-'+str(k) #0.009000001-'+str(k)
            with open('speedres/'+path+'.txt', 'r') as f:
                array = np.loadtxt(f)
            valuesnorm.append(array)
    ...
    plt.savefig('speedres/t'+str(time)+'sgd'+tipo+'RhoMeanfinal.pdf')
    plt.show()
...
def plotBestWorts(tipo, time):
    ...
    for i, G in zip(l,lGau):
        for k in range(n_experiments):
            path = 'sgd'+str(14)+'RhoMean'+tipo2+'lr0.05-w235.61944901923448a0.012-'+str(k) #0.009000001-'+str(k)
            with open('speedres/'+path+'.txt', 'r') as f:
                array = np.loadtxt(f)
            values.append(array)
            path = 'sgdUni'+tipo2+'lr0.05-w235.61944901923448a0.012-'+str(k) #0.009000001-'+str(k)
    ...
    for i, G in zip(l,lGau):
        for k in range(n_experiments):
            path = 'sgd'+str(14)+'RhoMean'+tipo2+'lr0.05-w282.7433388230814a0.012-'+str(k) #0.009000001-'+str(k)
            with open('speedres/'+path+'.txt', 'r') as f:
                array = np.loadtxt(f)
            values.append(array)
            path = 'sgdUni'+tipo2+'lr0.05-w282.7433388230814a0.012-'+str(k) #0.009000001-'+str(k)
    ...
    for i, G in zip(l,lGau):
        for k in range(n_experiments):
            path = 'sgd'+str(14)+'RhoMean'+tipo2+'lr0.01-w70.68583470577035a0.012-'+str(k) #0.009000001-'+str(k)
            with open('speedres/'+path+'.txt', 'r') as f:
                array = np.loadtxt(f)
            values.append(array)
            path = 'sgdUni'+tipo2+'lr0.01-w70.68583470577035a0.012-'+str(k) #0.009000001-'+str(k)
            with open('speedres/'+path+'.txt', 'r') as f:
                array = np.loadtxt(f)
            valuesuni.append(array)
            path = 'sgdGau'+tipo2+'lr0.01-w'+str(G)+'a0.012-'+str(k) #0.009000001-'+str(k)
            with open('speedres/'+path+'.txt', 'r') as f:
                array = np.loadtxt(f)
            valuesnorm.append(array)
    ...
    axs[2].legend(frameon=False, loc='upper right', fontsize='small')
    axs[2].xaxis.set_label_coords(0.5, -0.05)
    plt.savefig('speedres/15timesgd'+tipo+'RhoMeanfinal.pdf')
    plt.show()
