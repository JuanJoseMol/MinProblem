...
def bestTimeGau(tipo2):
    ...
    if tipo2 == "human":
        ...
        l = [2*v,4*v, 5*v,10*v,15*v,20*v,30*v,40*v,50*v]#[5*v,10*v,15*v,20*v,25*v,30*v,35*v,40*v,45*v,50*v]
        n_experiments = 44
        ...
        for i in l:
            ...
            for k in range(n_experiments):
                ...
                path = 'FBGau'+tipo2+'lr0.001-w'+str(i)+'a0.012-'+str(k) #0.009000001-'+str(k)
    ...
    if tipo2 == "brain":
        ...
        l = [2*v,4*v, 5*v,10*v,15*v,20*v,30*v,40*v,50*v]#[5*v,10*v,15*v,20*v,23.74*v,30*v,35*v,40*v,45*v,50*v,60*v,70*v,80*v,90*v]
        n_experiments = 43
        mean_values = []
        median_values = []
        min_values = []
    ...
    if tipo2 == "3d":
        ...
        l = [0.5*v,1*v, 2*v,3*v,4*v, 5*v, 6*v, 7*v,8*v]#[1*v, 2*v, 3*v, 4*v, 5*v, 6*v, 7*v, 8*v, 9*v, 10*v]
        n_experiments = 42
        mean_values = []
        median_values = []
        min_values = []
...
def bestTimeGauTrunc(tipo2):
    print ("best gaussian")
    v = np.pi
    if tipo2 == "human":
        #l = [0.0001,0.005,.01,0.05,0.1,0.5,1,1.5,2,3,4,5,6,7,8]
        l = [5*v,10*v,15*v,20*v,25*v,30*v,35*v,40*v,45*v,50*v]
        n_experiments = 44
        ...
        for i in l:
            ...
            for k in range(n_experiments):
                #path = 'Fix'+str(i)+'Mean'+tipo2+'lr0.001-w235.61944901923448a0.012-'+str(k) 
                path = 'TGau'+tipo2+'lr0.001-w'+str(i)+'a0.012-'+str(k) #0.009000001-'+str(k)
                with open('speedres/'+path+'.txt', 'r') as f:
                    array = np.loadtxt(f)
    ...
    if tipo2 == "3d":
        #l = [i for i in range(1,40)]
        l = [3*v, 4*v, 5*v, 6*v, 7*v, 8*v, 9*v, 10*v]
        n_experiments = 42
        mean_values = []
        median_values = []
        min_values = []
...
def bestTimeFix(tipo2):
    ...
    if tipo2 == "3d":
        ...
        for i in l:
            temp = []
            for k in range(n_experiments):
                path = 'Fix'+str(i)+'Mean'+tipo2+'lr0.001-w70.68583470577035a0.012-'+str(k) 
                #path = str(i)+'RhoMean'+tipo2+'lr0.01-w70.68583470577035a0.012-'+str(k) #0.009000001-'+str(k)
                with open('speedres/'+path+'.txt', 'r') as f:
                    array = np.loadtxt(f)
                temp.append(array[-1])
...
def plot(tipo):
    ...
    meanGau, medianGau, minimumGau = bestTimeGauTrunc(tipo2)
    ...
    for i, G in zip(l,lGau):
        for k in range(n_experiments):
            ...
            path = 'TGau'+tipo2+'lr0.001-w'+str(G)+'a0.012-'+str(k) #0.009000001-'+str(k)
            with open('speedres/'+path+'.txt', 'r') as f:
                array = np.loadtxt(f)
    ...
    for i, G in zip(l,lGau):
        for k in range(n_experiments):
            path = str(i)+'RhoMean'+tipo2+'lr0.001-w70.68583470577035a0.012-'+str(k) #0.009000001-'+str(k)
            with open('speedres/'+path+'.txt', 'r') as f:
                array = np.loadtxt(f)
            values.append(array)
    ...
    plt.savefig('speedres/Fix'+tipo+'RhoMeanfinal.pdf')
    plt.show()
    ...
    for i, G in zip(l,lGau):
        for k in range(n_experiments):
            ...
            with open('speedres/'+path+'.txt', 'r') as f:
                array = np.loadtxt(f)
            values.append(array)
            path = 'Uni'+tipo2+'lr0.001-w235.61944901923448a0.012-'+str(k) #0.009000001-'+str(k)
            with open('speedres/'+path+'.txt', 'r') as f:
                array = np.loadtxt(f)
            valuesuni.append(array)
            path = 'FBGau'+tipo2+'lr0.001-w'+str(G)+'a0.012-'+str(k) #0.009000001-'+str(k)
            with open('speedres/'+path+'.txt', 'r') as f:
                array = np.loadtxt(f)
            valuesnorm.append(array)
    ...
    for i, G in zip(l,lGau):
        for k in range(n_experiments):
            ...
            with open('speedres/'+path+'.txt', 'r') as f:
                array = np.loadtxt(f)
            values.append(array)
            path = 'Uni'+tipo2+'lr0.001-w282.7433388230814a0.012-'+str(k) #0.009000001-'+str(k)
            with open('speedres/'+path+'.txt', 'r') as f:
                array = np.loadtxt(f)
            valuesuni.append(array)
            path = 'FBGau'+tipo2+'lr0.001-w'+str(G)+'a0.012-'+str(k) #0.009000001-'+str(k)
    ...
    for i, G in zip(l,lGau):
        for k in range(n_experiments):
            ...
            with open('speedres/'+path+'.txt', 'r') as f:
                array = np.loadtxt(f)
            values.append(array)
            path = 'Uni'+tipo2+'lr0.001-w70.68583470577035a0.012-'+str(k) #0.009000001-'+str(k)
            with open('speedres/'+path+'.txt', 'r') as f:
                array = np.loadtxt(f)
            valuesuni.append(array)
            path = 'FBGau'+tipo2+'lr0.001-w'+str(G)+'a0.012-'+str(k) #0.009000001-'+str(k)
...
def plotFix(tipo):
    ...
    for i, G in zip(l,lGau):
        for k in range(n_experiments):
            path = 'Fix'+str(i)+'Mean'+tipo2+'lr0.001-w235.61944901923448a0.012-'+str(k) #0.009000001-'+str(k)
            with open('speedres/'+path+'.txt', 'r') as f:
                array = np.loadtxt(f)
            values.append(array)
            path = 'Uni'+tipo2+'lr0.001-w235.61944901923448a0.012-'+str(k) #0.009000001-'+str(k)
    ...
    for i, G in zip(l,lGau):
        for k in range(n_experiments):
            path = 'Fix'+str(i)+'Mean'+tipo2+'lr0.001-w282.7433388230814a0.012-'+str(k) #0.009000001-'+str(k)
            with open('speedres/'+path+'.txt', 'r') as f:
                array = np.loadtxt(f)
            values.append(array)
            path = 'Uni'+tipo2+'lr0.001-w282.7433388230814a0.012-'+str(k) #0.009000001-'+str(k)
    ...
    for i, G in zip(l,lGau):
        for k in range(n_experiments):
            path = 'Fix'+str(i)+'Mean'+tipo2+'lr0.001-w70.68583470577035a0.012-'+str(k) #0.009000001-'+str(k)
            with open('speedres/'+path+'.txt', 'r') as f:
                array = np.loadtxt(f)
            values.append(array)
            path = 'Uni'+tipo2+'lr0.001-w70.68583470577035a0.012-'+str(k) #0.009000001-'+str(k)
    ...
    axs[2].legend(frameon=False, loc='upper right', fontsize='small')
    axs[2].xaxis.set_label_coords(0.5, -0.05)
    plt.savefig('speedres/Fix'+tipo+'Meanfinal.pdf')
    plt.show()
...
def plotStd(tipo):
    ...
    for i, G in zip(l,lGau):
        for k in range(n_experiments):
            ...
            with open('speedres/'+path+'.txt', 'r') as f:
                array = np.loadtxt(f)
            values.append(array)
            path = 'Uni'+tipo2+'lr0.001-w249.75661596038856a0.012-'+str(k) #0.009000001-'+str(k)
            with open('speedres/'+path+'.txt', 'r') as f:
                array = np.loadtxt(f)
            valuesuni.append(array)
            path = 'FBGau'+tipo2+'lr0.001-w'+str(G)+'a0.012-'+str(k) #0.009000001-'+str(k)
    ...
    mean_values = np.mean(applied_results, axis=0)
    std_values = np.std(applied_results, axis=0)

    mean_valuesuni = np.mean(uni, axis=0)
    std_valuesuni = np.std(uni, axis=0)

    mean_valuesnorm = np.mean(norm, axis=0)
    std_valuesnorm = np.std(norm, axis=0)

    min_values = mean_values - std_values
    max_values = mean_values + std_values

    min_valuesuni = mean_valuesuni - std_valuesuni
    max_valuesuni = mean_valuesuni + std_valuesuni

    min_valuesnorm = mean_valuesnorm - std_valuesnorm
    max_valuesnorm = mean_valuesnorm + std_valuesnorm
    ...
    #plt.plot(min_values, color='blue', linestyle='--', label='Minimum')
    #plt.plot(max_values, color='red', linestyle='--', label='Maximum')
    axs[1].plot(mean_values, color='blue', linewidth=2, label='RhoMean')
    axs[1].plot(mean_valuesuni, color='red', linewidth=2, label='Uniform')
    axs[1].plot(mean_valuesnorm, color='green', linewidth=2, label='Normal')
    ...
    #plt.plot(min_values, color='blue', linestyle='--', label='Minimum')
    #plt.plot(max_values, color='red', linestyle='--', label='Maximum')
    axs[0].plot(mean_values, color='blue', linewidth=2, label='RhoMean')
    axs[0].plot(mean_valuesuni, color='red', linewidth=2, label='Uniform')
    axs[0].plot(mean_valuesnorm, color='green', linewidth=2, label='Normal')
    ...
    #plt.plot(min_values, color='blue', linestyle='--', label='Minimum')
    #plt.plot(max_values, color='red', linestyle='--', label='Maximum')
    axs[2].plot(mean_values, color='blue', linewidth=2, label='Design')
    axs[2].plot(mean_valuesuni, color='red', linewidth=2, label='Uniform')
    axs[2].plot(mean_valuesnorm, color='green', linewidth=2, label='Normal')
    ...
    axs[2].legend(frameon=False, loc='upper right', fontsize='small')
    axs[2].xaxis.set_label_coords(0.5, -0.05)
    plt.savefig('speedres/MeanStd'+tipo+'RhoMeanfinal.pdf')
    plt.show()
...
if __name__ == '__main__':
    ...
    bestTimeGauTrunc("brain")
    bestTimeGauTrunc("human")
    bestTimeGauTrunc("3d")
