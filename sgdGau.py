        ...
        for file in files:
          ...
          if file.endswith('T1w.nii.gz'):
            ...
            for sigma_W in listw:#, (sigmaA,180), (sigmaA*1000,180)]: 
              ...
              with open('speedres/2sgdGau'+tipo2+'lr'+str(lr)+'-w'+str(sigma_W)+'a'+str(sigmaA.round(3))+'-'+str(k)+'.txt', 'w') as f:
...
if __name__ == "__main__":
  ...
  #learnigspeed("3d", [6*v,7*v] ,1000, lr) #[[2*v,3*v,4*v,5*v,6*v,7*v]], , 2*v,3*v,4*v, 7*v, 8*v, 9*v
  #learnigspeed("human", [35*v,40*v,45*v,50*v,55*v] ,1000, lr) #,10*v,15*v, 20*v, 25*v,30*v
  learnigspeed("brain", [25*v,30*v, 35*v] ,1000, lr) #,10*v,15*v, 20*v, 25*v, 30*v[35*v,40*v,45*v,50*v,55*v]
