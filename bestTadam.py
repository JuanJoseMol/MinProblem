...
def bestTimeGau2(tipo2, time=-1):
    ...
    if tipo2 == "human":
        ...
        for i in l:
            ...
            for k in range(n_experiments):
                ...
                try:
                    path = 'adamGau'+tipo2+'lr0.001-w'+str(i)+'a0.012-'+str(k) #0.009000001-'+str(k)
    ...
    if tipo2 == "3d":
        ...
        l = [2*v,3*v,4*v,5*v,6*v,7*v,8*v, 9*v, 20*v]
        n_experiments = 42
        mean_values = []
        median_values = []
        min_values = []
...
def bestTimeGau(tipo2, time=-1):
    ...
    if tipo2 == "human":
        #l = [0.0001,0.005,.01,0.05,0.1,0.5,1,1.5,2,3,4,5,6,7,8]
        l = [55*v,10*v,15*v, 20*v, 25*v,30*v,35*v,40*v,45*v,50*v] 
        n_experiments = 96
        ...
        for i in l:
            ...
            for k in range(n_experiments):
                #path = 'Fix'+str(i)+'Mean'+tipo2+'lr0.001-w235.61944901923448a0.012-'+str(k) 
                try:
                    path = '2adamGau'+tipo2+'lr0.001-w'+str(i)+'a0.012-'+str(k) #0.009000001-'+str(k)
                    with open('speedres/'+path+'.txt', 'r') as f:
                        array = np.loadtxt(f)
                except Exception:
                    continue
    ...
    if tipo2 == "3d":
        #l = [i for i in range(1,40)]
        l = [2*v,3*v,4*v,5*v,6*v,7*v, 8*v, 9*v]
        n_experiments = 96
        mean_values = []
        median_values = []
        min_values = []
...
def bestTime(tipo2, time):
    ...
    if tipo2 == "human":
        #l = [0.0001,0.005,.01,0.05,0.1,0.5,1,1.5,2,3,4,5,6,7,8]
        l = [2**(-i-1) for i in range(3)]+[i for i in range(1,18)]
        n_experiments = 44
        mean_values = []
        median_values = []
        min_values = []
        for i in l:
            ...
            for k in range(n_experiments):
                #path = 'Fix'+str(i)+'Mean'+tipo2+'lr0.001-w235.61944901923448a0.012-'+str(k) 
                path = 'adam'+str(i)+'RhoMean'+tipo2+'lr0.001-w235.61944901923448a0.012-'+str(k) #0.009000001-'+str(k)
                with open('speedres/'+path+'.txt', 'r') as f:
                    array = np.loadtxt(f)
    ...
    if tipo2 == "brain":
        #l = [i for i in range(1,33)]
        l = [i for i in range(1,18)]+[2**(-i-1) for i in range(3)]	
        n_experiments = 43
        mean_values = []
        median_values = []
        min_values = []
        for i in l:
            ...
            for k in range(n_experiments):
                #path = 'Fix'+str(i)+'Mean'+tipo2+'lr0.001-w282.7433388230814a0.012-'+str(k)
                path = 'adam'+str(i)+'RhoMean'+tipo2+'lr0.001-w282.7433388230814a0.012-'+str(k) #0.009000001-'+str(k)
                with open('speedres/'+path+'.txt', 'r') as f:
                    array = np.loadtxt(f)
                temp.append(array[time])
                # Store results
        ...
        return best_mean_function[0], best_median_function[0], best_min_function[0]
    if tipo2 == "3d":
        l = [1,2,3,4,5,6,7,8,9]+[2**(-i-1) for i in range(3)]#+[82]
        n_experiments = 42
        mean_values = []
        median_values = []
        min_values = []
        for i in l:
            ...
            for k in range(n_experiments):
                #path = 'Fix'+str(i)+'Mean'+tipo2+'lr0.01-w70.68583470577035a0.012-'+str(k) 
                path = 'adam'+str(i)+'RhoMean'+tipo2+'lr0.001-w70.68583470577035a0.012-'+str(k) #0.009000001-'+str(k)
                with open('speedres/'+path+'.txt', 'r') as f:
                    array = np.loadtxt(f)
                temp.append(array[time])
                # Store results
...
def plot(tipo, time):
    ...
    for i, G in zip(l,lGau):
        for k in range(n_experiments):
            ...
            with open('speedres/'+path+'.txt', 'r') as f:
                array = np.loadtxt(f)
            values.append(array)
            path = 'adamUni'+tipo2+'lr0.001-w235.61944901923448a0.012-'+str(k) #0.009000001-'+str(k)
            with open('speedres/'+path+'.txt', 'r') as f:
                array = np.loadtxt(f)
            valuesuni.append(array)
            path = 'adamGau'+tipo2+'lr0.001-w'+str(G)+'a0.012-'+str(k) #0.009000001-'+str(k)
            with open('speedres/'+path+'.txt', 'r') as f:
                array = np.loadtxt(f)
    ...
    for i, G in zip(l,lGau):
        for k in range(n_experiments):
            ...
            with open('speedres/'+path+'.txt', 'r') as f:
                array = np.loadtxt(f)
            values.append(array)
            path = 'adamUni'+tipo2+'lr0.001-w282.7433388230814a0.012-'+str(k) #0.009000001-'+str(k)
            with open('speedres/'+path+'.txt', 'r') as f:
                array = np.loadtxt(f)
            valuesuni.append(array)
            path = 'adamGau'+tipo2+'lr0.001-w'+str(G)+'a0.012-'+str(k) #0.009000001-'+str(k)
    ...
    for i, G in zip(l,lGau):
        for k in range(n_experiments):
            ...
            with open('speedres/'+path+'.txt', 'r') as f:
                array = np.loadtxt(f)
            values.append(array)
            path = 'adamUni'+tipo2+'lr0.001-w70.68583470577035a0.012-'+str(k) #0.009000001-'+str(k)
            with open('speedres/'+path+'.txt', 'r') as f:
                array = np.loadtxt(f)
            valuesuni.append(array)
            path = 'adamGau'+tipo2+'lr0.001-w'+str(G)+'a0.012-'+str(k) #0.009000001-'+str(k)
    ...
    plt.savefig('speedres/t'+str(time)+'adam'+tipo+'RhoMeanfinal.pdf')
    plt.show()
